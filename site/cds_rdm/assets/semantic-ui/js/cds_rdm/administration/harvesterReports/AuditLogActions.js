...
import { HarvesterViewRecentChanges } from "./ViewRecentChanges";
import { ViewJson } from "./ViewJson";

export class HarvesterAuditLogActions extends Component {
  constructor(props) {
    super(props);
    this.state = {
      modalOpen: false,
...
HarvesterAuditLogActions.propTypes = {
...
HarvesterAuditLogActions.defaultProps = {
  Element: Button,
  actions: undefined,
};
